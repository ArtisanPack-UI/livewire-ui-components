...
- Livewire Volt allows PHP logic and Blade templates in one file. Components use the `@livewire("
  volt-anonymous-fragment-eyJuYW1lIjoidm9sdC1hbm9ueW1vdXMtZnJhZ21lbnQtNTNlNDRjOWRhZTNmZDZjOTJiN2M2OTU1ZmNlMDYzYzciLCJwYXRoIjoic3RvcmFnZVwvZnJhbWV3b3JrXC92aWV3c1wvMTE3MzI2YjJmNDg4NmViODZiNGFmZjZhNjRiNzY3MDEuYmxhZGUucGhwIn0=",
...
To get started, define an anonymous class that extends Livewire\Volt\Component. Within the class, you may utilize all of
...
This project uses the ArtisanPack UI ecosystem. You should use its components and packages when available.

### Accessibility (artisanpack-ui/accessibility)

* Utilize functions from the artisanpack-ui/accessibility package to ensure the application adheres to accessibility
  best
* practices.
* This includes implementing proper HTML semantics, full keyboard navigability, sufficient color contrast, and logical
* heading structures.

### Security (artisanpack-ui/security)

* Leverage the artisanpack-ui/security package to implement robust security measures.
* This includes, but is not limited to, maintaining up-to-date dependencies, enforcing HTTPS, sanitizing and validating
* all user input, and protecting against common vulnerabilities like XSS and CSRF.

### Code Style (artisanpack-ui/code-style)

* All PHP code must adhere to the standards defined in the artisanpack-ui/code-style package.
* Key rules include:
    * Use real tabs for indentation.
    * Use Yoda conditionals (e.g., if (true === $condition)).
    * Use single quotes unless variable escaping is required.
    * Adhere to naming conventions: PascalCase for classes, camelCase for functions/variables.
    * Use short array syntax.
    * Add type declarations wherever possible.
    * Do not use die, exit, var_dump, or print_r.
