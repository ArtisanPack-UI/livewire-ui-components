...
As I mentioned before, there are a ton of different ways to contribute to ArtisanPack UI even if you're not a developer. Here are some (but not all) of the ways you can contribute to the project.
...
* Write documentation
* Write tutorials and talk about Digital Shopfront on your blog and/or social media profiles

## How to File a Bug Report

To file a bug report, please [add a new issue](https://gitlab.com/jacob-martella-web-design/artisanpack-ui/artisanpack-ui-components/-/issues/new).

Next, select the bug report template and fill it out as much as you can.

Please add in your environment (operating system, browser, etc.) and describe the problem as much as you can. Screenshots and videos help a ton.
...
To file a feature request, please [add a new issue](https://gitlab.com/jacob-martella-web-design/artisanpack-ui/artisanpack-ui-components/-/issues/new).

Next, select the feature request template and fill it out as much as you can.

Please describe what you want the feature to be as much as possible and why it should be in that ArtisanPack UI package.

Please select the Awaiting Review milestone and add the necessary labels to the task.

Once you've filled out the issue, you can submit it and it will be reviewed by a maintainer as quickly as possible. Maintainers might ask you questions about the feature request, so please be as responsive as possible to make a decision on whether to include it in ArtisanPack UI in a timely manner.
...
* Feature - For merge requests that merge a new feature into ArtisanPack UI.
* Task - For merge requests that complete a task issue.

The release template is only used for ArtisanPack UI releases and can only be added by maintainers.
...
To keep things consistent across the code base, it's important to keep the naming conventions the same.
