...
- [**Upgrading from v1.x to v2.0**](v1-to-v2) - Guide for upgrading to v2.0, including new dashboard components, table export, and streaming content (no breaking changes)
