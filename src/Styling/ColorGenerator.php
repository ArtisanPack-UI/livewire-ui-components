...
namespace ArtisanPackUI\LivewireUIComponents\Styling;
...
class ColorGenerator
{
	...
	public function generateThemeCss( string $primaryColor, string $secondaryColor, string $accentColor ): string
	{
		...
		$daisyTheme['primary-content']  = $a11y->a11yGetContrastColor( $primaryBase );
		$daisyTheme['secondary']     = $secondaryBase;
		$daisyTheme['secondary-content'] = $a11y->a11yGetContrastColor( $secondaryBase );
		$daisyTheme['accent']        = $accentBase;
		$daisyTheme['accent-content']  = $a11y->a11yGetContrastColor( $accentBase );
		...
		$css .= "\n    /* --- DaisyUI Utility & Component Variables --- */\n";
