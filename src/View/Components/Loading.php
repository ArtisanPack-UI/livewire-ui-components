...
class Loading extends Component
{
    ...
    public function getLoadingType(): string
    {
        ...
        return config( 'artisanpack.livewire-ui-components.livewire-ui-components.icons.loading.default_type', 'css');
    }
    ...
    public function getLoadingIcon(): ?string
    {
        ...
        return config( 'artisanpack.livewire-ui-components.livewire-ui-components.icons.loading.spinner');
    }
