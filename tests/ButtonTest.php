...
test('button uses primary variant by default', function () {
    $button = new Button();
...
test('button accepts valid variants', function () {
    $validVariants = [
        'primary' => 'btn-primary',
...
test('button falls back to primary for invalid variants', function () {
...
test('button maintains existing functionality', function () {
    $button = new Button(
        id: 'test-btn',
        label: 'Test Button',
        icon: 'save',
...
test('button generates uuid', function () {
    $button = new Button();
...
test('button color prop overrides variant', function () {
...
test('button resolves predefined color variants', function () {
...
test('button resolves tailwind colors', function () {
...
test('button resolves tailwind colors without intensity', function () {
...
test('button resolves hex colors', function () {
...
test('button applies color adjustments', function () {
...
test('button handles invalid colors', function () {
...
test('button maintains backward compatibility when no color specified', function () {
...
test('button color adjustment with variants', function () {
