...
test('resolves predefined variants', function () {
    $variants = [
        'primary' => [
            'bg' => 'bg-primary', 
...
test('resolves tailwind colors with intensity', function () {
    $colors = [
        'red-500' => [
...
test('resolves tailwind colors without intensity', function () {
    $colors = [
        'red' => [
            'style' => '--artisanpack-tailwind-color: #ef4444; --artisanpack-tailwind-hover-color: #dc2626; --artisanpack-tailwind-focus-color: #dc2626;',
            'bg' => '[background-color:var(--artisanpack-tailwind-color)]',
...
test('resolves hex colors', function () {
...
test('applies color adjustments', function () {
...
test('applies hex adjustments', function () {
...
test('handles invalid colors', function () {
    $invalidColors = [
        'invalid-color',
        'not-a-hex',
        'blue-1000',
...
test('handles null color input', function () {
    $result = $this->colorGenerator->resolveComponentColor(null, null, 'button');
    expect($result)->toBeEmpty();
});

test('variant adjustments work correctly', function () {
...
test('contrasting text calculation', function () {
...
test('ghost and outline variants', function () {
...
test('component context parameter', function () {
