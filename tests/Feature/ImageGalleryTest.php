...
test('renders grid layout with default columns', function () {
    $images = [
...
test('configures custom responsive columns', function () {
...
test('configures aspect ratio correctly', function () {
    $images = ['image1.jpg', 'image2.jpg'];
...
test('configures gap settings', function () {
    $images = ['image1.jpg', 'image2.jpg'];
...
test('configures lightbox and caption settings', function () {
    $images = ['image1.jpg', 'image2.jpg'];
...
test('configures layout and lazy loading', function () {
    $images = ['image1.jpg', 'image2.jpg'];
...
test('configures filtering system', function () {
    $images = ['image1.jpg', 'image2.jpg'];
...
test('configures pagination settings', function () {
    $images = ['image1.jpg', 'image2.jpg'];
...
test('returns correct gap classes', function () {
    $images = ['image1.jpg'];
...
test('returns correct grid column classes', function () {
    $images = ['image1.jpg'];
    $customColumns = [
        'default' => 2,
        'sm' => 3,
...
test('returns correct loading classes', function () {
    $images = ['image1.jpg'];
...
test('validates array props correctly', function () {
    $images = ['image1.jpg'];
...
test('validates string props correctly', function () {
    $images = ['image1.jpg'];
...
test('handles complex column configuration', function () {
    $images = ['image1.jpg'];
    $complexColumns = [
        'default' => 1,
        'sm' => 2,
...
test('supports null filters correctly', function () {
    $images = ['image1.jpg'];
...
test('supports empty filters array', function () {
    $images = ['image1.jpg'];
...
test('supports different layout options', function () {
    $images = ['image1.jpg'];
...
test('supports pagination disabled with zero items per page', function () {
    $images = ['image1.jpg'];
...
test('supports different loading styles', function () {
    $images = ['image1.jpg'];
