...
{
    public function test_pagination_component_accepts_variant_parameters(): void
    {
    ...
    public function test_pagination_component_generates_correct_variant_classes(): void
    {
        $items     = Collection::range(1, 100);
        $paginated = new LengthAwarePaginator($items->take(10), 100, 10, 1);
    ...
    public function test_pagination_component_handles_size_parameter_correctly(): void
    {
        $items     = Collection::range(1, 100);
        $paginated = new LengthAwarePaginator($items->take(10), 100, 10, 1);
    ...
    public function test_should_show_per_page_selector_method_works_correctly(): void
    {
        $items     = Collection::range(1, 100);
        $paginated = new LengthAwarePaginator($items->take(10), 100, 10, 1);
    ...
    public function test_should_show_page_info_method_works_correctly(): void
    {
        $items     = Collection::range(1, 100);
        $paginated = new LengthAwarePaginator($items->take(10), 100, 10, 1);
    ...
    public function test_multiple_variants_cannot_be_active_simultaneously(): void
    {
        $items     = Collection::range(1, 100);
        $paginated = new LengthAwarePaginator($items->take(10), 100, 10, 1);
