...
/**
 * Comprehensive unit tests for the Accordion component.
 *
 ...
 */
class AccordionComponentTest extends ComponentTestCase
{
    protected string $componentClass = Accordion::class;
    ...
    public function test_accordion_string_properties(): void
    {
        $stringProperties = ['id', 'uuid'];
    ...
    public function test_accordion_boolean_properties(): void
    {
        $booleanProperties = ['noJoin'];
    ...
    public function test_accordion_renders_successfully(): void
    {
    ...
    public function test_accordion_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view      = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Accordion should have valid HTML structure. Issues: '.implode(', ', $validation['issues']),
        );
    }

    public function test_accordion_security_against_xss(): void
    {
    ...
    public function test_accordion_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Accordion rendering should be under 100ms on average',
            );
