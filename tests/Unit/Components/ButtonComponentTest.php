...
class ButtonComponentTest extends ComponentTestCase
{
    ...
    {
        $stringProperties = ['id', 'label', 'icon', 'iconRight', 'spinner', 'link', 'badge', 'badgeClasses', 'tooltip', 'tooltipLeft', 'tooltipRight', 'tooltipBottom', 'variant', 'color', 'colorAdjustment', 'uuid', 'tooltipPosition'];
