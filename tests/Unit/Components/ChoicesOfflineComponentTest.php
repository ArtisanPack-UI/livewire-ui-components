 ...
 */
class ChoicesOfflineComponentTest extends ComponentTestCase
{
    ...
    public function test_choicesoffline_security_against_xss(): void
    {
    ...
    public function test_choicesoffline_performance(): void
    {
        try {
