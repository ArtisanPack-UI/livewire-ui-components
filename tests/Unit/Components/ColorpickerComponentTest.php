 ...
 */
class ColorpickerComponentTest extends ComponentTestCase
{
    ...
    public function test_colorpicker_security_against_xss(): void
    {
    ...
    public function test_colorpicker_performance(): void
    {
        try {
