 ...
 */
class DiffComponentTest extends ComponentTestCase
{
    ...
    public function test_diff_setup_method(): void
    {
    ...
    public function test_diff_diff_method(): void
    {
        $component = $this->createComponent();

        if (method_exists($component, 'diff')) {
            try {
    ...
    public function test_diff_security_against_xss(): void
    {
    ...
    public function test_diff_performance(): void
    {
        try {
