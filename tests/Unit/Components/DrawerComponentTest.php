...
/**
 * Comprehensive unit tests for the Drawer component.
 *
 ...
 */
class DrawerComponentTest extends ComponentTestCase
{
    protected string $componentClass = Drawer::class;
    ...
    public function test_drawer_string_properties(): void
    {
        $stringProperties = ['id', 'title', 'subtitle', 'actions'];
    ...
    public function test_drawer_boolean_properties(): void
    {
        $booleanProperties = ['right', 'separator', 'withCloseButton', 'closeOnEscape', 'withoutTrapFocus'];
    ...
    public function test_drawer_id_method(): void
    {
    ...
    public function test_drawer_model_name_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_drawer_renders_successfully(): void
    {
        $component = $this->createComponent();
    ...
    public function test_drawer_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view      = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Drawer should have valid HTML structure. Issues: '.implode(', ', $validation['issues']),
        );
    }

    public function test_drawer_security_against_xss(): void
    {
    ...
    public function test_drawer_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Drawer rendering should be under 100ms on average',
            );
