 ...
 */
class ImageLibraryComponentTest extends ComponentTestCase
{
    ...
    public function test_imagelibrary_library_name_method(): void
    {
        ...
        if (method_exists($component, 'libraryName')) {
            try {
    ...
    public function test_imagelibrary_validation_message_method(): void
    {
        ...
        if (method_exists($component, 'validationMessage')) {
            try {
    ...
    public function test_imagelibrary_crop_setup_method(): void
    {
        ...
        if (method_exists($component, 'cropSetup')) {
            try {
    ...
    public function test_imagelibrary_security_against_xss(): void
    {
    ...
    public function test_imagelibrary_performance(): void
    {
        try {
