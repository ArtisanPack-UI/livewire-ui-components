...
class InputComponentTest extends ComponentTestCase
{
    ...
    public function test_input_model_name_method(): void
    {
    ...
    public function test_input_error_field_name_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_input_is_readonly_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_input_is_disabled_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_input_money_settings_method(): void
    {
        $component = $this->createComponent();
