...
/**
 * Comprehensive unit tests for the Menu component.
 * 
 ...
 */
class MenuComponentTest extends ComponentTestCase
{
    protected string $componentClass = Menu::class;
    ...
    public function test_menu_string_properties(): void
    {
        $stringProperties = ['id', 'title', 'icon', 'iconClasses', 'activeBgColor'];
    ...
    public function test_menu_boolean_properties(): void
    {
        $booleanProperties = ['separator', 'activateByRoute'];
    ...
    public function test_menu_renders_successfully(): void
    {
    ...
    public function test_menu_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Menu should have valid HTML structure. Issues: ' . implode(', ', $validation['issues'])
        );
    }

    public function test_menu_security_against_xss(): void
    {
    ...
    public function test_menu_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Menu rendering should be under 100ms on average'
            );
