 ...
 */
class PaginationComponentTest extends ComponentTestCase
{
    protected string $componentClass = Pagination::class;
    ...
    protected array $defaultProperties = [
            ...
            'size' => 'default',
            'showPageInfo' => true,
            'pageInfoTemplate' => 'Showing {from} to {to} of {total} results'
        ];
    ...
    public function test_pagination_string_properties(): void
    {
        $stringProperties = ['id', 'size', 'pageInfoTemplate'];
    ...
    public function test_pagination_boolean_properties(): void
    {
        $booleanProperties = ['simple', 'compact', 'advanced', 'minimal', 'hidePerPage', 'hidePageInfo', 'showFirstLast', 'showJumpTo', 'showPageInfo'];
    ...
    public function test_pagination_array_properties(): void
    {
        $arrayProperties = ['perPageValues'];
    ...
    public function test_pagination_modelName_method(): void
    {
    ...
    public function test_pagination_isShowable_method(): void
    {
        $component = $this->createComponent();

        if (method_exists($component, 'isShowable')) {
            try {
                $result = $component->isShowable();
                // Add specific assertions based on expected return type
                $this->assertNotNull($result);
            } catch (\Error $e) {
                if (str_contains($e->getMessage(), 'Call to a member function') &&
    ...
    public function test_pagination_getVariantClasses_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_pagination_shouldShowPerPageSelector_method(): void
    {
        $component = $this->createComponent();

        if (method_exists($component, 'shouldShowPerPageSelector')) {
            try {
                $result = $component->shouldShowPerPageSelector();
                // Add specific assertions based on expected return type
                $this->assertNotNull($result);
            } catch (\Error $e) {
                if (str_contains($e->getMessage(), 'Call to a member function') &&
    ...
    public function test_pagination_shouldShowPageInfo_method(): void
    {
        $component = $this->createComponent();

        if (method_exists($component, 'shouldShowPageInfo')) {
            try {
                $result = $component->shouldShowPageInfo();
                // Add specific assertions based on expected return type
                $this->assertNotNull($result);
            } catch (\Error $e) {
                if (str_contains($e->getMessage(), 'Call to a member function') &&
    ...
    public function test_pagination_renders_successfully(): void
    {
        $component = $this->createComponent();
    ...
    public function test_pagination_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Pagination should have valid HTML structure. Issues: ' . implode(', ', $validation['issues'])
        );
    }

    public function test_pagination_security_against_xss(): void
    {
    ...
    public function test_pagination_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Pagination rendering should be under 100ms on average'
            );
