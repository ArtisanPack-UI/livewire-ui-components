 ...
 */
class ProfileComponentTest extends ComponentTestCase
{
    ...
    public function test_profile_security_against_xss(): void
    {
    ...
    public function test_profile_performance(): void
    {
        try {
