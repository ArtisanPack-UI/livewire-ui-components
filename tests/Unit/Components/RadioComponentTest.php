...
/**
 * Comprehensive unit tests for the Radio component.
 *
 ...
 */
class RadioComponentTest extends ComponentTestCase
{
    ...
    public function test_radio_string_properties(): void
    {
    ...
    public function test_radio_boolean_properties(): void
    {
        $booleanProperties = ['inline', 'card', 'omitError', 'firstErrorOnly'];
    ...
    public function test_radio_model_name_method(): void
    {
    ...
    public function test_radio_error_field_name_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_radio_renders_successfully(): void
    {
        $component = $this->createComponent();
    ...
    public function test_radio_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view      = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Radio should have valid HTML structure. Issues: '.implode(', ', $validation['issues']),
        );
    }

    public function test_radio_security_against_xss(): void
    {
    ...
    public function test_radio_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Radio rendering should be under 100ms on average',
            );
