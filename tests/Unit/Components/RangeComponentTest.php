...
/**
 * Comprehensive unit tests for the Range component.
 *
 ...
 */
class RangeComponentTest extends ComponentTestCase
{
    protected string $componentClass = Range::class;
    ...
    public function test_range_string_properties(): void
    {
    ...
    public function test_range_boolean_properties(): void
    {
    ...
    public function test_range_model_name_method(): void
    {
    ...
    public function test_range_error_field_name_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_range_renders_successfully(): void
    {
        $component = $this->createComponent();
    ...
    public function test_range_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view      = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Range should have valid HTML structure. Issues: '.implode(', ', $validation['issues']),
        );
    }

    public function test_range_security_against_xss(): void
    {
    ...
    public function test_range_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Range rendering should be under 100ms on average',
            );
