...
/**
 * Comprehensive unit tests for the Subheading component.
 *
 ...
 */
class SubheadingComponentTest extends ComponentTestCase
{
    protected string $componentClass = Subheading::class;
    ...
    public function test_subheading_string_properties(): void
    {
        $stringProperties = ['id', 'size', 'color'];
    ...
    public function test_subheading_boolean_properties(): void
    {
        $booleanProperties = ['semibold', 'bold', 'center', 'muted'];
    ...
    public function test_subheading_font_weight_class_method(): void
    {
    ...
    public function test_subheading_color_class_method(): void
    {
        $component = $this->createComponent();
    ...
    public function test_subheading_renders_successfully(): void
    {
        $component = $this->createComponent();
    ...
    public function test_subheading_accessibility_compliance(): void
    {
        $component = $this->createComponent();
        $view      = $component->render();
        ...
        $this->assertTrue($validation['is_valid'],
            'Subheading should have valid HTML structure. Issues: '.implode(', ', $validation['issues']),
        );
    }

    public function test_subheading_security_against_xss(): void
    {
    ...
    public function test_subheading_performance(): void
    {
        try {
            ...
            $this->assertLessThan(100, $performance['average_time'],
                'Subheading rendering should be under 100ms on average',
            );
