 ...
 */
class ThemeToggleComponentTest extends ComponentTestCase
{
    ...
    public function test_themetoggle_security_against_xss(): void
    {
    ...
    public function test_themetoggle_performance(): void
    {
        try {
