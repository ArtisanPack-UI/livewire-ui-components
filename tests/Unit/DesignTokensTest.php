...
describe('Design Token System', function (): void {
    ...
    */
    ...
    describe('Typography Tokens', function (): void {

        it('returns typography token defaults', function (): void {
        ...
        it('has correct font size values', function (): void {
            $tokens = $this->generator->getTypographyTokenDefaults();
        ...
        it('has correct font weight values', function (): void {
            $tokens = $this->generator->getTypographyTokenDefaults();
        ...
        it('has correct line height values', function (): void {
            $tokens = $this->generator->getTypographyTokenDefaults();
    ...
    */
    ...
    describe('Spacing Tokens', function (): void {

        it('returns spacing token defaults', function (): void {
        ...
        it('has correct spacing values based on 0.25rem increments', function (): void {
            $tokens = $this->generator->getSpacingTokenDefaults();
        ...
        it('includes large spacing values', function (): void {
            $tokens = $this->generator->getSpacingTokenDefaults();
    ...
    */
    ...
    describe('Border Radius Tokens', function (): void {

        it('returns radius token defaults', function (): void {
        ...
        it('has correct radius values', function (): void {
            $tokens = $this->generator->getRadiusTokenDefaults();
    ...
    */
    ...
    describe('Shadow Tokens', function (): void {

        it('returns shadow token defaults', function (): void {
        ...
        it('has colored shadow variants', function (): void {
            $tokens = $this->generator->getShadowTokenDefaults();
        ...
        it('has glow effect variants', function (): void {
            $tokens = $this->generator->getShadowTokenDefaults();
        ...
        it('returns dark mode shadow overrides', function (): void {
        ...
        it('has darker shadows for dark mode', function (): void {
    ...
    */
    ...
    describe('Animation Tokens', function (): void {

        it('returns animation token defaults', function (): void {
        ...
        it('has standard easing functions', function (): void {
            $tokens = $this->generator->getAnimationTokenDefaults();
        ...
        it('has expressive easing functions', function (): void {
            $tokens = $this->generator->getAnimationTokenDefaults();
        ...
        it('has correct duration values', function (): void {
            $tokens = $this->generator->getAnimationTokenDefaults();
        ...
        it('has correct easing cubic bezier values', function (): void {
            $tokens = $this->generator->getAnimationTokenDefaults();
        ...
        it('has transition presets', function (): void {
            $tokens = $this->generator->getAnimationTokenDefaults();
    ...
    */
    ...
    describe('All Design Tokens Combined', function (): void {

        it('returns all design tokens organized by category', function (): void {
        ...
        it('each category contains the correct tokens', function (): void {
            $allTokens = $this->generator->getAllDesignTokenDefaults();
    ...
    */
    ...
    describe('Design Tokens CSS Generation', function (): void {

        it('generates CSS with all token categories', function (): void {
        ...
        it('generates CSS with @theme directive', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('generates CSS with :root selector', function (): void {
            $css = $this->generator->generateDesignTokensCss();

            expect($css)->toContain(':root {');
        });

        it('generates CSS with dark mode overrides', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes typography tokens in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes spacing tokens in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes radius tokens in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes shadow tokens in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes animation tokens in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes glass tokens in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
        ...
        it('includes computed glass colors in generated CSS', function (): void {
            $css = $this->generator->generateDesignTokensCss();
    ...
    */
    ...
    describe('Design Tokens CSS Generation with Overrides', function (): void {

        it('applies typography overrides', function (): void {
            $overrides = [
                'typography' => [
        ...
        it('applies spacing overrides', function (): void {
            $overrides = [
                'spacing' => [
                    'spacing-4' => '1.25rem',
                ],
        ...
        it('applies radius overrides', function (): void {
            $overrides = [
                'radius' => [
                    'radius-lg' => '1rem',
                ],
        ...
        it('applies shadow overrides', function (): void {
            $overrides = [
                'shadow' => [
        ...
        it('applies animation overrides', function (): void {
            $overrides = [
                'animation' => [
                    'duration-200' => '250ms',
                ],
        ...
        it('applies glass overrides', function (): void {
            $overrides = [
                'glass' => [
                    'glass-blur' => '16px',
                ],
        ...
        it('applies multiple category overrides simultaneously', function (): void {
            $overrides = [
